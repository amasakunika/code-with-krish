...
export class OrdersService implements OnModuleInit{
  ...
  private readonly consumer = this.Kafka.consumer({groupId: "ama-order-service"});
...
for(const item of items){
  ...
  //if keep only EX, always anyone can update, to be ATOMIC, need to pass NX
}

// produce as an event (kafka event)

this.producer.send({
  topic: `ama.order.create`,
  messages:[{
